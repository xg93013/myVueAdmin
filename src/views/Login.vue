<template>
	<div class="login-wrapper">
		<el-form ref="AccountForm" :model="account" :rules="rules" label-position="left" label-width="0px" class="login-form login-container">
          ...
          if (valid) {
            let loginParams = {username: this.account.username, password: this.account.pwd};
              ...
              // 登录成功
                ...
                MyStorage.setStorage('access-user', JSON.stringify(res.user));
